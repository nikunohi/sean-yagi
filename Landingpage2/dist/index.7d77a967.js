...
container.style.height = '200vh'; // Adjust this based on content height
...
window.addEventListener('scroll', ()=>{
    ...
    document.querySelectorAll('.photos1').forEach((img, index)=>{
        ...
        const progress = Math.min(scrollPosition / viewportHeight, 1); // Clamped between 0 and 1
...
//# sourceMappingURL=index.7d77a967.js.map
