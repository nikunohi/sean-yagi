...
})({"e6jIv":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1ee702b564b0b21b";
"use strict";
...
},{}],"8hXXZ":[function(require,module,exports,__globalThis) {
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const handleScroll1 = ()=>{
        ...
        if (scrollPos > 200 && scrollPos > lastScrollTop1) image1.classList.add('active');
        else if (scrollPos < lastScrollTop1) image1.classList.remove('active');
    ...
    setTimeout(()=>{
        ...
        const handleScroll2 = ()=>{
            const scrollPos = window.scrollY;
            // Add 'active' class when scrolling down beyond a threshold
            if (scrollPos > 200 && scrollPos > lastScrollTop2) image2.classList.add('active');
            else if (scrollPos < lastScrollTop2) image2.classList.remove('active');
    ...
    const handleScroll3 = ()=>{
        const scrollPos = window.scrollY;
        // Add 'active' class when scrolling down beyond a threshold
        if (scrollPos > 200 && scrollPos > lastScrollTop3) image3.classList.add('active');
        else if (scrollPos < lastScrollTop3) image3.classList.remove('active');
    ...
    const handleScroll4 = ()=>{
        const scrollPos = window.scrollY;
        // Add 'active' class when scrolling down beyond a threshold
        if (scrollPos > 200 && scrollPos > lastScrollTop4) image3.classList.add('active');
        else if (scrollPos < lastScrollTop4) image3.classList.remove('active');
...
},{}]},["e6jIv","8hXXZ"], "8hXXZ", "parcelRequire94c2")

//# sourceMappingURL=index.64b0b21b.js.map
